...
curl -fsS \
    ...
    https://api.github.com/repos/rccgis-uchicago/spack-batteries-included/releases > release_info.json
...
do
    ...
    curl -fsS \
         ...
         --data-binary "@$name" \
         "https://uploads.github.com/repos/rccgis-uchicago/spack-batteries-included/releases/$release_id/assets?name=$name)"
done